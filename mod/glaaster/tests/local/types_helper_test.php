...
final class types_helper_test extends mod_glaaster_testcase {
    ...
    public function test_get_lti_types_by_course(): void {
        ...
        $coursetooltypes = types_helper::get_lti_types_by_course(
            $course->id,
            $teacher->id,
            [MOD_GLAASTER_COURSEVISIBLE_PRECONFIGURED]
        );
    ...
    public function test_override_type_showinactivitychooser(): void {
        ...
        /*
            ...
            | site     | MOD_GLAASTER_COURSEVISIBLE_NO              |                      |
            | site     | MOD_GLAASTER_COURSEVISIBLE_PRECONFIGURED   |                      |
            | site     | MOD_GLAASTER_COURSEVISIBLE_ACTIVITYCHOOSER | yes                  |
            | site     | MOD_GLAASTER_COURSEVISIBLE_ACTIVITYCHOOSER | yes                  |
            | course   | MOD_GLAASTER_COURSEVISIBLE_ACTIVITYCHOOSER |                      |
        */
        ...
        // MOD_GLAASTER_COURSEVISIBLE_NO can't be updated.
        ...
        $this->assertEquals(MOD_GLAASTER_COURSEVISIBLE_ACTIVITYCHOOSER, $cvisibleoverriden);
        ...
        $this->assertEquals(MOD_GLAASTER_COURSEVISIBLE_PRECONFIGURED, $coursevisible);
        ...
        $this->assertEquals(MOD_GLAASTER_COURSEVISIBLE_PRECONFIGURED, $cvisibleoverriden);
