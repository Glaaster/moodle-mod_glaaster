...
class mod_glaaster_edit_types_form extends moodleform {
    ...
    public function definition() {
        ...
        if (!$istool) {
            $options = [
                MOD_GLAASTER_VERSION_1 => get_string('oauthsecurity', 'glaaster'),
                MOD_GLAASTER_VERSION_1P3 => get_string('jwtsecurity', 'glaaster'),
            ];
            ...
            $mform->setDefault('lti_ltiversion', MOD_GLAASTER_VERSION_1);
            ...
            $mform->hideIf('lti_resourcekey', 'lti_ltiversion', 'eq', MOD_GLAASTER_VERSION_1P3);
            ...
            $mform->hideIf('lti_password', 'lti_ltiversion', 'eq', MOD_GLAASTER_VERSION_1P3);
            ...
            if (!empty($typeid)) {
                ...
                $mform->hideIf('lti_clientid_disabled', 'lti_ltiversion', 'neq', MOD_GLAASTER_VERSION_1P3);
            ...
            $keyoptions = [
                MOD_GLAASTER_RSA_KEY => get_string('keytype_rsa', 'glaaster'),
                MOD_GLAASTER_JWK_KEYSET => get_string('keytype_keyset', 'glaaster'),
            ];
            ...
            $mform->setDefault('lti_keytype', MOD_GLAASTER_JWK_KEYSET);
            $mform->hideIf('lti_keytype', 'lti_ltiversion', 'neq', MOD_GLAASTER_VERSION_1P3);
            ...
            $mform->hideIf('lti_publickey', 'lti_keytype', 'neq', MOD_GLAASTER_RSA_KEY);
            $mform->hideIf('lti_publickey', 'lti_ltiversion', 'neq', MOD_GLAASTER_VERSION_1P3);
            ...
            $mform->hideIf('lti_publickeyset', 'lti_keytype', 'neq', MOD_GLAASTER_JWK_KEYSET);
            $mform->hideIf('lti_publickeyset', 'lti_ltiversion', 'neq', MOD_GLAASTER_VERSION_1P3);
            ...
            $mform->hideIf('lti_initiatelogin', 'lti_ltiversion', 'neq', MOD_GLAASTER_VERSION_1P3);
            ...
            $mform->hideIf('lti_redirectionuris', 'lti_ltiversion', 'neq', MOD_GLAASTER_VERSION_1P3);
        ...
        if (!empty($this->_customdata->isadmin)) {
            ...
            if (empty($this->_customdata->iscoursetool) || !$this->_customdata->iscoursetool) {
                $options = [
                    MOD_GLAASTER_COURSEVISIBLE_NO => get_string('show_in_course_no', 'glaaster'),
                    MOD_GLAASTER_COURSEVISIBLE_PRECONFIGURED => get_string('show_in_course_preconfigured', 'glaaster'),
                    MOD_GLAASTER_COURSEVISIBLE_ACTIVITYCHOOSER => get_string(
                ...
                if ($istool) {
                    ...
                    unset($options[MOD_GLAASTER_COURSEVISIBLE_NO]);
            ...
            $mform->addElement('hidden', 'lti_coursevisible', MOD_GLAASTER_COURSEVISIBLE_ACTIVITYCHOOSER);
        }
        ...
        $launchoptions = [];
        $launchoptions[MOD_GLAASTER_LAUNCH_CONTAINER_EMBED] = get_string('embed', 'glaaster');
        $launchoptions[MOD_GLAASTER_LAUNCH_CONTAINER_EMBED_NO_BLOCKS] = get_string('embed_no_blocks', 'glaaster');
        $launchoptions[MOD_GLAASTER_LAUNCH_CONTAINER_REPLACE_MOODLE_WINDOW] = get_string('existing_window', 'glaaster');
        $launchoptions[MOD_GLAASTER_LAUNCH_CONTAINER_WINDOW] = get_string('new_window', 'glaaster');
        ...
        $mform->setDefault('lti_launchcontainer', MOD_GLAASTER_LAUNCH_CONTAINER_EMBED_NO_BLOCKS);
        ...
        if (!$istool) {
            ...
            if (!empty($this->_customdata->isadmin)) {
                ...
                $options = [
                    MOD_GLAASTER_DEFAULT_ORGID_SITEID => get_string('siteid', 'glaaster'),
                    MOD_GLAASTER_DEFAULT_ORGID_SITEHOST => get_string('sitehost', 'glaaster'),
                ];
                ...
                $mform->setDefault('lti_organizationid_default', MOD_GLAASTER_DEFAULT_ORGID_SITEID);
    ...
    public function validation($data, $files) {
        ...
        if (isset($data['lti_ltiversion']) && $data['lti_ltiversion'] == MOD_GLAASTER_VERSION_1P3) {
    ...
    public function definition_after_data() {
        ...
        foreach (['lti_sendname', 'lti_sendemailaddr'] as $elementname) {
            if (
                ...
                && $this->_form->_defaultValues[$elementname] == MOD_GLAASTER_SETTING_DELEGATE
            ) {
