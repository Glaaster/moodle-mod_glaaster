...
class course_external_tools_list extends system_report {
    ...
    protected function initialise(): void {
        ...
        $params = array_merge(
            $params,
            [
                $coursevisibleparam => MOD_GLAASTER_COURSEVISIBLE_NO,
                $categoryparam => $this->course->category,
                $toolstateparam => MOD_GLAASTER_TOOL_STATE_CONFIGURED,
            ]
        );
    ...
    protected function add_columns(tool_types $tooltypesentity): void {
        ...
        $this->add_column((new column(
            ...
            ->set_callback(function (int $id, stdClass $row): string {
                ...
                if ($coursevisible == MOD_GLAASTER_COURSEVISIBLE_ACTIVITYCHOOSER) {
                    $coursevisible = true;
                } else {
                    $coursevisible = false;
                }
